...
<head>
    ...
    <title>Booking Perjalanan - ENKA TOUR</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg stiky-top bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold custom-primary fs-2" href="#home">ENKA TOUR</a>
        </div>
    </nav>
                            ...
                            <form action="{{ url('/submit-booking') }}" method="POST" class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" id="package" name="package" required>
                                        ...
                                        <option value="bali-barat" data-price="850000">Bali Barat / Bali Utara Tour
                                        </option>
                                        <option value="blambangan-lumajang" data-price="700000">Blambangan - Lumajang
                                        </option>
                                        <option value="bromo-malang" data-price="1650000">Bromo - Malang Tour</option>
                                        <option value="malang-tour" data-price="1500000">Malang Tour</option>
                                        <option value="yogya-tour" data-price="1600000">Yogya Tour</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" id="transportation" name="transportation" required>
                                        ...
                                        <option value="bus-35">Bis dengan Seat penumpang 35</option>
                                        <option value="bus-45">Bis dengan Seat penumpang 45</option>
                                        <option value="elf-16">Elf dengan Seat penumpang 16</option>
                                    </select>
                                </div>

                                <!-- Pilihan Guide -->
                                <div class="col-12">
                                    <label class="form-label fw-bold">Apakah Anda ingin menyertakan guide/pemandu
